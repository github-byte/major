export function seedDatabase(firebase) {
  ...
  firebase.firestore().collection('series').add({
    ...
    genre: 'documentaries',
    link: 'https://www.youtube.com/watch?v=acTdxsoa428&ab_channel=Netflix',
    maturity: '18',
    slug: 'tiger-king',
  });
  firebase.firestore().collection('series').add({
    ...
    genre: 'documentaries',
    link: 'https://www.youtube.com/watch?v=mRLt2xBpQbQ',
    maturity: '12',
    slug: 'amanda-knox',
  });
  firebase.firestore().collection('series').add({
    ...
    genre: 'documentaries',
    link: 'https://www.youtube.com/watch?v=rHaWhUjV96M',
    maturity: '82',
    slug: 'citizenfour',
  });
  firebase.firestore().collection('series').add({
  ...
  firebase.firestore().collection('series').add({
    ...
    genre: 'comedies',
    link: 'https://www.youtube.com/watch?v=LHOtME2DL4g',
    maturity: '15',
    slug: 'the-office',
  });
  firebase.firestore().collection('series').add({
    ...
    genre: 'comedies',
    link: 'https://www.youtube.com/watch?v=vzVhPCMAxWQ',
    maturity: '45',
  ...
  firebase.firestore().collection('series').add({
    ...
    genre: 'comedies',
    link: 'https://www.youtube.com/watch?v=zRCMPMGDN00',
    maturity: '15',
  ...
  firebase.firestore().collection('series').add({
    ...
    genre: 'comedies',
    link: 'https://www.youtube.com/watch?v=rlQlCz7xnek',
    maturity: '15',
    slug: 'family-guy',
  });
  firebase.firestore().collection('series').add({
  ...
  firebase.firestore().collection('series').add({
    ...
    genre: 'children',
    link: 'https://www.youtube.com/watch?v=Oozdpz12Ejo',
    maturity: '0',
    category:'series',
    slug: 'peppa-pig',
  });
  firebase.firestore().collection('series').add({
    ...
    genre: 'children',
    link: 'https://www.youtube.com/watch?v=TnpTcrtsN3U',
    maturity: '0',
    category:'series',
  ...
  firebase.firestore().collection('series').add({
    ...
    genre: 'children',
    link: 'https://www.youtube.com/watch?v=LRMTr2VZcr8',
    maturity: '0',
    category:'series',
    slug: 'paw-patrol',
  });
  firebase.firestore().collection('series').add({
    ...
    genre: 'children',
    link: 'https://www.youtube.com/watch?v=6rbPTQIdjmY',
    maturity: '0',
    category:'series',
    slug: 'arthur',
  });
  ...
  firebase.firestore().collection('series').add({
    ...
    genre: 'crime',
    link: 'https://www.youtube.com/watch?v=qxgbdYaR_KQ',
    maturity: '18',
  ...
  firebase.firestore().collection('series').add({
    ...
    genre: 'crime',
    link: 'https://www.youtube.com/watch?v=S5jiaHvx-kY',
    maturity: '18',
    slug: 'long-shot',
  });
  firebase.firestore().collection('series').add({
    ...
    genre: 'crime',
    link: 'https://www.youtube.com/watch?v=mWPbC9Fp-yk',
    maturity: '18',
  ...
  firebase.firestore().collection('series').add({
    ...
    genre: 'crime',
    link: 'https://www.youtube.com/watch?v=4LYiAEV_XnA',
    maturity: '38',
  ...
  firebase.firestore().collection('series').add({
    ...
    genre: 'crime',
    link: 'https://www.youtube.com/watch?v=Bvv97sCcruY',
    maturity: '18',
    slug: 'the-staircase',
  });
  ...
  firebase.firestore().collection('series').add({
    ...
    genre: 'feel-good',
    link: 'https://www.youtube.com/watch?v=TExoc0MG4I4',
    maturity: '12',
    slug: 'school-of-rock',
  });
  ...
  firebase.firestore().collection('films').add({
    ...
    genre: 'drama',
    link: 'https://www.youtube.com/watch?v=RLtaA9fFNXU',
    maturity: '15',
    slug: 'the-prestige',
  });
  firebase.firestore().collection('films').add({
  ...
  firebase.firestore().collection('films').add({
    ...
    genre: 'children',
    link: 'https://www.youtube.com/watch?v=q4RK3jY7AVk',
    maturity: '0',
  ...
  firebase.firestore().collection('films').add({
    ...
    genre: 'children',
    link: 'https://www.youtube.com/watch?v=zzCZ1W_CUoI',
    maturity: '0',
    slug: 'despicable-me',
  });
  firebase.firestore().collection('films').add({
    ...
    genre: 'children',
    link: 'https://www.youtube.com/watch?v=FLzfXQSPBOg',
    maturity: '0',
    slug: 'frozen',
  });
  firebase.firestore().collection('films').add({
  ...
  firebase.firestore().collection('films').add({
    ...
    genre: 'children',
    link: 'https://www.youtube.com/watch?v=ORFWdXl_zJ4',
    maturity: '0',
    slug: 'up',
  });
  ...
  firebase.firestore().collection('films').add({
    ...
    genre: 'thriller',
    link: 'https://www.youtube.com/watch?v=u1uP_8VJkDQ',
    maturity: '15',
    slug: 'nightcrawler',
  });
  firebase.firestore().collection('films').add({
  ...
  firebase.firestore().collection('films').add({
    ...
    genre: 'romance',
    link: 'https://www.youtube.com/watch?v=yDJIcYE32NU',
    maturity: '25',
    slug: 'the-notebook',
  });
  firebase.firestore().collection('films').add({
